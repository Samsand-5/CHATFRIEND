package com.example.chatfriend
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getResponse(query: String) {
        queryEdt.setText("")
        val query : RequestQueue = Volley.newRequestQueue(applicationContext)
        ...
        val postRequest: JsonObjectRequest = object:JsonObjectRequest(Method.POST,url,jsonObject,Response.Listener { response ->
            ...
            override fun getHeaders(): MutableMap<String, String> {
                ...
                params["Authorization"]="Bearer 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 "
                return params
            }
        }
